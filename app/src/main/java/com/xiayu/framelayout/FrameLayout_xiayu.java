...
public class FrameLayout_xiayu extends ViewGroup {
    ...
    public FrameLayout_xiayu(@NonNull Context context) {
        super(context);
    }

    public FrameLayout_xiayu(@NonNull Context context, @Nullable AttributeSet attrs) {
...
/*        final TypedArray a = context.obtainStyledAttributes(
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new FrameLayout_xiayu.LayoutParams(getContext(), attrs);
    }
